...
module.exports = {
  ...
  repo: 'rideWind97', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: '乘风', // 必需
    link: 'https://github.com/rideWind97', // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/rideWind97',
      },
      // {
  ...
  footer: {
    ...
    copyrightInfo:
      'rideWind97 | <a href="https://github.com/rideWind97" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  }
}